...
@section('title', 'Tambah Jurusan Asal')
@section('content')
<div class="card">
    <div class="card-body">
        @if ($errors->any())
            ...
            @endif
        <form method="POST" action="{{ url('jurusan_asal') }}" class="form-horizontal">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12"> 
                    ...
                    <div class="form-group">        
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama jurusan asal">
                    </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='{{ url('jurusan_asal') }}'">Kembali</button>
