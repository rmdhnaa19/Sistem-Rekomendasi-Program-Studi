...
<div class="card">
    <div class="card-body">
        @if ($errors->any())
            ...
            @endif
        <form method="POST" action="{{ url('organisasi') }}" class="form-horizontal">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12"> 
                    ...
                    <div class="form-group">        
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama organisasi">
                    </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='{{ url('organisasi') }}'">Kembali</button>
