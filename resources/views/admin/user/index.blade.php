                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="image-container text-center" style="position: sticky; top: 20px;">
                                    <img src="" alt="Foto User" class="img-fluid" style="width: auto; height: 30vh;">
                                </div>
                            </div>
                            <div class="col-md-7">
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Event listener for viewing user details
            ...
            // Add "Tambah" button after search input
            ...
            $("#btn-tambah").on('click', function() {
                window.location.href = "{{ url('user/create') }}"; // Redirect to user creation page
            });

            // Adding placeholder to search field
